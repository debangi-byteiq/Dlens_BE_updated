  ...
  return (
    <div className="chartContainer2">
      <div className="d-flex justify-content-between">
        <div style={{ fontSize: "24px", color: "#204496" }}>All Storage</div>
          ...
          >
            ...
            <defs>
              <linearGradient id="gradientColor2" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#204496" stopOpacity={1} />
                <stop offset="50%" stopColor="#204496" stopOpacity={0.3} />
                <stop offset="100%" stopColor="#204496" stopOpacity={0.1} />
              </linearGradient>
            </defs>
            <CartesianGrid
              vertical={false}
            ...
            <Tooltip
              ...
              labelStyle={{ color: "#204496" }}
              itemStyle={{ color: "#204496" }}
