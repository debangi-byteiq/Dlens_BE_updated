  ...
  return (
    <div className="chartContainer4">
      <div className="d-flex justify-content-between">
        <div style={{ fontSize: "24px", color: "#EA4648" }}>Non Open</div>
          ...
          >
            <defs>
              <linearGradient id="gradientColor4" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#EA4648" stopOpacity={1} />
                <stop offset="50%" stopColor="#EA4648" stopOpacity={0.3} />
                <stop offset="100%" stopColor="#EA4648" stopOpacity={0.1} />
              </linearGradient>
            </defs>
            <CartesianGrid
              vertical={false}
            ...
            <Tooltip
              ...
              labelStyle={{ color: "#EA4648" }}
              itemStyle={{ color: "#EA4648" }}
