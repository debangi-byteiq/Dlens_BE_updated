...
import Postgressetup from "../../../assets/Images/postgresSetup.svg";
import postgres from "../../../assets/Images/Sources/Prostgres.svg";
...
const PostgresDashboard = () => {
  ...
  return (
    <div className="body">
      <h5 className="mx-2 fw-bold">Create a new source</h5>
        ...
        <Row gutter={[16, 16]}>
          <Col span={12}>
            ...
            <Card>
              ...
              <img src={postgres} alt="postgres" className="right-image" />
            </Card>
            ...
            <Card className="sql-card">
              ...
              <Form.Item name="sslModel" label={<span>SSL Method</span>}>
