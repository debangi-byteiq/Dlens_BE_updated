...
from app.core.runtime_checks import configure_hadoop_home, find_postgres_jdbc_jar
import tempfile
...
class Main:
    ...
    def init_spark_session(self):
        ...
        postgres_jdbc_jar = find_postgres_jdbc_jar()
        if postgres_jdbc_jar:
            builder = builder.config("spark.jars", str(postgres_jdbc_jar))
